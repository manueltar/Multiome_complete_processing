...
Rscript_LinkPeaks=$(echo "$Rscripts_path""424_LinkPeaks_new_annotation.R")
 
adata=$(echo "/group/soranzo/manuel.tardaguila/2025_hESC_MK_multiome/Downstream_analysis_cluster_after_genotyping/""merged_clusters_after_genotyping_after_refined_annotation_rpca_new_peaks.rds")
DE_genes=$(echo "/group/soranzo/manuel.tardaguila/2025_hESC_MK_multiome/Downstream_analysis_cluster_after_genotyping/AFTER_RPCA_INTEGRATION/DE_per_identity/DE_results.tsv")
