...
search_terms=$(echo 'NEAT2,MALAT1,PLATELET,ERYTHROCYTE,MEGAKARYOCYTE,CHEK2,ATM,DNMT3A,HEMATOPOIETIC,HEMATOPOIESIS,CLONAL,EMBRYONIC,STEM,GRAHAM_NORMAL_QUIESCENT_VS_NORMAL_DIVIDING_DN,RUNX1,GATA2,CUX1,CREB5,GATA1,GATA6,BCL11A,BCL11B,MAZ,NR2F1,PROX1,ZBTB7A')
