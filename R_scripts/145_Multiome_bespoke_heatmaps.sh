...
selected_annotations_other=$(echo "In-house,cycle,G2M")
#selected_annotations_other=$(echo "DESCARTES_FETAL_LIVER_MEGAKARYOCYTES,HP_INCREASED_MEAN_PLATELET_VOLUME")
